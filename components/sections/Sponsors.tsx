...
export const Sponsors = () => {
  return (
    <div className=' w-full flex flex-col items-center justify-center'>
        ...
        <div className='sm:px-20 px-4 sm:pt-16 pt-20 rounded-t-xl border-t-[2px] min-h-screen border-gray-600 w-full  my-10 sticky top-0 bg-gradient-to-b from-gray-700 via-gray-500 to-gray-600'>
            <h1 className='bg-gradient-to-b from-gray-600 via-gray-200 to-gray-400 text-transparent bg-clip-text text-center w-full mx-auto sm:text-[3.3rem] text-[2.3rem] font-bold' >Silver</h1>
            <div>
                <h2 className='text-center font-semibold text-[1.5rem]'>-- //   Will be added later   \\ --</h2>
            </div>
        </div>
