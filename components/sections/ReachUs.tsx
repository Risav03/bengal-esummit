...
export const ReachUs = () => {
  return (
    <div className='sm:px-20 px-4 sm:pt-16 max-w-screen w-full flex flex-col items-center justify-start sticky sm:-top-16 max-sm:-top-28 min-h-screen rounded-t-xl border-t-[2px] border-slate-700 pt-20 bg-gradient-to-b from-slate-900 to-slate-950'>
