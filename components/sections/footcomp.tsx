...
export const FootComp = () => {
  return (
    <div className='w-full h-[8rem] flex flex-col gap-4 sticky top-[20rem] items-center justify-center bg-gradient-to-br from-slate-800 via-slate-900 to-slate-950 rounded-t-xl border-slate-500 border-t-[1px]'>
