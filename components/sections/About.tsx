...
export const About = () => {
  return (
    <div className=' sm:px-20 px-4 w-[100%] sticky sm:-top-16 max-sm:-top-28 max-w-screen min-h-screen flex flex-col items-center justify-center rounded-t-xl border-t-[2px] border-slate-700 py-20 bg-gradient-to-b from-slate-900 to-slate-950 sm:py-16'>
