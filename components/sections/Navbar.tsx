...
export const Navbar = () => {
  ...
  return (
    <div className='fixed top-0 left-0 z-[999999] sm:h-screen max-sm:w-full sm:w-[4rem] flex sm:flex-col items-center justify-center'>
      ...
      <a href="https://docs.google.com/forms/d/1XbC47b8Be39CNYPusKcHVZOr6M02mT_2oLQERUG2jYU/viewform?edit_requested=true" target='_blank' className='absolute top-20 bg-red-500 p-5 w-[6rem] flex justify-end left-0 font-bold hover:bg-red-400 hover:-translate-x-8 -translate-x-10 duration-200 rounded-r-xl max-sm:hidden'><GiArchiveRegister/></a>
      <a href="https://docs.google.com/forms/d/1XbC47b8Be39CNYPusKcHVZOr6M02mT_2oLQERUG2jYU/viewform?edit_requested=true" target="_blank" className='absolute top-[85dvh] right-5 bg-red-500 p-4 text-2xl font-bold hover:bg-red-400 hover:-translate-y-2 duration-200 sm:hidden rounded-full'><GiArchiveRegister/></a>
